...
export default function Footer() {
  ...
  const socialLinks = [
    { 
      icon: <FaFacebookF />, 
      url: storeSettings?.facebookUrl || fallbackData.facebookUrl,
      gradient: "from-blue-600 to-blue-700",
      name: "Facebook"
    },
    { 
      icon: <FaTwitter />, 
      url: storeSettings?.twitterUrl || fallbackData.twitterUrl,
      gradient: "from-sky-400 to-sky-600",
      name: "Twitter"
    },
    { 
      icon: <FaInstagram />, 
      url: storeSettings?.instagramUrl || fallbackData.instagramUrl,
      gradient: "from-pink-500 to-purple-600",
      name: "Instagram"
    },
    { 
      icon: <FaLinkedinIn />, 
      url: storeSettings?.linkedinUrl || fallbackData.linkedinUrl,
    ...
    <footer className="relative bg-gray-50">
      ...
      <div className="bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12 lg:justify-items-center">
            ...
            <div className="bg-gray-900 rounded-2xl p-6 relative overflow-hidden lg:justify-self-end">
              {/* Background Pattern */}
              ...
              <div className="relative">
                {/* Icon Badge */}
               <div className="flex gap-2 items-top justify-start">
                 <div className="inline-flex items-center justify-center w-10 h-10 bg-white/20 backdrop-blur-sm rounded-xl mb-4">
             ...
             <div>
                ...
                <div className="bg-white/10 backdrop-blur-md rounded-xl p-3">
                  <form onSubmit={handleSubscribe} className="space-y-3">
                    <input
                      ...
                      className="w-full px-3 py-2 bg-white/20 backdrop-blur rounded-lg text-white text-xs placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-white/40 transition-all"
                    />
                    <button 
                      type="submit" 
                      disabled={loading}
                      className="w-full px-4 py-2 bg-white text-gray-900 font-semibold rounded-lg hover:bg-gray-50 hover:shadow-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2 text-xs"
                    >
                      {loading ? (
                  ...
                  {status && (
                    <p className={`mt-2 text-xs ${status.includes('✓') ? 'text-green-200' : 'text-red-200'}`}>
                      {status}
                    </p>
                  )}
                </div>
                ...
                {/* Trust Indicators */}
                <div className="flex items-center justify-center space-x-3 mt-3 text-xs text-white/70">
